...
$context['page_notfound_image'] = $options['404_page_bg_image'] ?? esc_url(
	get_template_directory_uri() . '/images/404-header.jpg',
);
$context['page_notfound_text'] = $options['404_page_text'] ?? __(
