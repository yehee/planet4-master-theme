...
class MasterSite extends TimberSite
{
	 ...
	 */
	public function add_restricted_tags_box(): void
	{
	 ...
	 * @param WP_Post $post Post object.
	 */
	public function print_restricted_tags_box(WP_Post $post): void
	{
	 ...
	 */
	public function remove_default_tags_box(): void
	{
	 ...
	 */
	private function render_partial(string $path, array $args = []): void
	{
		if (! empty($args)) {
	 ...
	 *
	 * @return array<string> The youtube ID and the query string.
	 */
